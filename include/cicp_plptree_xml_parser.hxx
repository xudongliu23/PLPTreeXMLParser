...
#ifndef CICP_PLPTREE_XML_PARSER_HXX
#define CICP_PLPTREE_XML_PARSER_HXX
...
class child_t: public ::xml_schema::type
{
  public:
  // attribute
  //
  typedef ::xml_schema::string attribute_type;
...
::std::auto_ptr< ::child_t >
child (const ::xercesc::DOMDocument& d,
       ::xml_schema::flags f = 0,
       const ::xml_schema::properties& p = ::xml_schema::properties ());
...
#endif // CICP_PLPTREE_XML_PARSER_HXX
